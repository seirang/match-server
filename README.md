...
## 프로그램 소개
리그오브레전드 팀 짜기 프로그램 입니다. 입력 유저가 10명이 됐을때 5 대 5 팀을 짭니다.  
라인 우선과 티어 우선으로 팀 밸런스를 맞추는 두가지 모드가 있습니다.  
원하는 유저를 선택하여 단골 유저로 저장하고 팀 대기열에 불러올 수 있습니다.
### 사용방법
유저 입력: 소환사명과 태그를 입력칸에 입력합니다.(예: Hideonbush#KR1) (여러명을 한꺼번에 입력하여도 한 줄에 한 명씩 자동 파싱됩니다.)  
단골 설정: 프로필 아이콘 옆 별 표시를 클릭합니다.  
팀 생성: 팀 생성 버튼이 활성화되면 클릭합니다.
